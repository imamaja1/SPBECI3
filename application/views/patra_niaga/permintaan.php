...
<body>
    ...
    <script type="text/javascript">
        ...
        function varifikasi_fix(param, nopol) {
            kode_skid_tank = param;
            $('#skid_tank').modal('hide');
            $("#view_nopol").val(nopol)
            $.ajax({
                type: 'GET',
                url: " <?= base_url() ?>Rest_API/skid_tank?KEY-SPBE=SPBE&id=" + kode_skid_tank,
